...
assert circle._Circle__radius() - true_radius < 0.01, \
    "Неправильная формула расчета радиуса. Используйте 0-й элемент списка сторон и делите его на (2 * math.pi)"
true_area = math.pi
...
circle = Circle((255, 150, 150), 31.4)
